form:			//                    R0 		      R1            R2
 				// void form(int32_t *p32, uint16_t *pu16, uint8_t ku8){
				//   *(p32  + ku8) = 0xff;
				//	 *(pu16 + ku8) = 0xff;
				//}
				LDR		R3,=0xff
...
_start:			// Program Starts Here
				...
				LDR		R0,=wordArray		// array base address
				LDR		R1,=shortArray		// array base address
				LDR		R2,=2				// which element?
				BL		form				// call form function
